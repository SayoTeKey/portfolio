...
const MyProjects = () => {
  return (
    <>
      ...
      {/* Project 1 */}
      <a
        onClick={() => navigate("/pro1")}
        href=""
        className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800  dark:hover:bg-purple-900 mb-10"
      >
        <img
        ...
        <div className="flex flex-col justify-between p-4 leading-normal">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
            ...
            quibusdam ipsa consequatur libero eveniet cum minima nostrum
      ...
      >
        ...
        <div className="flex flex-col justify-between p-4 leading-normal">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
            ...
            distinctio, soluta neque dolores saepe, pariatur ducimus repellendus
            recusandae iste!
          </p>
        </div>
      </a>
      ...
      <a
        href=""
        className="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow-sm md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 mb-10"
      >
        <img
          className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-48 md:rounded-none md:rounded-s-lg"
          src={picturePro3}
      ...
      >
        ...
        <div className="flex flex-col justify-between p-4 leading-normal">
          ...
          <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">
            ...
            tempora autem enim, eos quisquam iste repellendus expedita. Id illum
            libero suscipit!
          </p>
        </div>
      </a>
